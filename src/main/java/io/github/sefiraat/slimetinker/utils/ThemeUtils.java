...
public final class ThemeUtils {
    ...
    public static final String LORE_LIQUID = ITEM_TYPEDESC + "金属产物";
    ...
    public static final String LORE_MOD = ITEM_TYPEDESC + "改装部件";
    public static final String LORE_PROP = ITEM_TYPEDESC + "材质特性";
